...
<section class="share-story stepper-section container-fluid"> <!--  Stepper section    -->
    <div class="d-flex justify-content-center">
        <div class="stepper col-12 col-md-10">
            <form:form action="${ontextPath}/story/edit" id="storyForm" name="story" role="form" method="post" modelAttribute="story" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="uploade-img-box">
                                            <div class="image-preview"   style="${story.imgList.size()>0 && story.imgList[0]!=null ? background: url(story.imgList[0]) : ''}">
                                        ...
                                        <div class="uploade-img-box">
                                            <div class="image-preview"  style="${story.imgList.size()>1 && story.imgList[1]!=null ? background: url(story.imgList[1]) : ''}">
                                                <button class="btn btnc-delete"><i class="fa fa-times" aria-hidden="true"></i></button>
                                            </div>
                                            <div class="upload-options">
                                                <label>
                                        ...
                                        <div class="uploade-img-box">
                                            <div class="image-preview"  style="${story.imgList.size()>2 && story.imgList[2]!=null ? background: url(story.imgList[2]) : ''}">
                                                <button class="btn btnc-delete"><i class="fa fa-times" aria-hidden="true"></i></button>
                                            </div>
                                            <div class="upload-options">
                                                <label>
