...
<div class="scholarship">
    ...
    <div class="container view-opportunity-box">
        ...
        <p><b>Opportunity Degree: </b> <span id="degree">${scholarship.degree}</span></p>
        <p id="major"><b>Major:</b></p>
        <c:forEach items="${academicInformation.major}" var="majors">
            <p data-major="${majors}"></p>
        </c:forEach>

        <p><b>Teaching Language </b> <span id="teaching-language">${academicInformation.teachingLanguage}</span></p>
        <br><br>
    </div>
    ...
    <div class="container view-opportunity-box">
        ...
        <p><b>Resident in: </b> <span id="resident-country">${applicantRequirement.residenceIn} </span></p>
        ...
        <p><b>Minimum Degree Held: </b> <span id="min-degree">${applicantRequirement.minDegree}</span></p>
